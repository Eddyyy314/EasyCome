...
const files = [
  ...
  'js/legal-config.js', 'js/legal-page.js', 'js/recesso.js', 'js/privacy-consent.js', 'js/auth-page.js', 'js/account.js', 'js/profile.js', 'js/app.js', 'js/generator-core.js', 'js/sales-config.js', 'js/admin-config.js', 'js/admin.js', 'js/factory.js', 'js/demo-live.js', 'js/web-demo.js',
];
