...
export default async function handler(req,res){
  ...
  try{
    ...
    checks.push({label:'Notifiche supporto',ok:Boolean(process.env.EASYCOME_SUPPORT_WEBHOOK_URL),ms:0,detail:process.env.EASYCOME_SUPPORT_WEBHOOK_URL?'Webhook attivo':'Solo inbox amministratore'});
