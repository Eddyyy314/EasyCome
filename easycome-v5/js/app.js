(function () {
  ...
  const TEMPLATES = [
    { id: 'complete', icon: '◆', name: 'Ecosistema PMI completo', description: 'Gestionale, dati, attività, preventivi, pagamenti, report, automazioni, app e Hub.', industry: 'Impresa e servizi', modules: ['crm','tasks','quotes','payments','reports','automations','multiuser','website','mobile_app','branding','ai','easycome_hub'] },
