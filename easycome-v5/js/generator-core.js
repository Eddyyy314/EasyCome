...
`;
  ...
  function generatePackage(projectInput) {
    ...
    const files = [
      ...
      ...((project.modules || []).includes('website') && global.EasyComeWebBuilder ? global.EasyComeWebBuilder.buildProjectFiles(project) : ((project.modules || []).includes('website') ? [
        { name: 'public-site/index.html', data: generatedPublicSite(project) },
        { name: 'public-site/README.md', data: '# Sito pubblico\n\nSito coordinato con il gestionale. Carica js/website-builder.js per generare il pacchetto Web Factory completo.\n' },
      ] : [])),
