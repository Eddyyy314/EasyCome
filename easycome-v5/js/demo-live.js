(function(){
  ...
  function listPreset(label){
    ...
    if(s.includes('oggi')||s.includes('front'))return {title:'Oggi',sub:'Arrivi, partenze, camere e saldi in un’unica vista operativa',heads:['Ora','Ospite','Alloggio','Stato'],rows:[['14:30','Giulia Romano','Deluxe 2','Check-in'],['16:00','Marco De Luca','Matrimoniale 1','Pronto'],['17:30','Anna Klein','Family','Da preparare']]};
