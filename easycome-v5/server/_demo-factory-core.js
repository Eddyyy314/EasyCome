...
export function buildProject(place,_templateId='hospitality',ownerEmail=''){
  ...
  p.delivery.packagePrice=183;p.delivery.implementationSelected=true;p.delivery.implementationPrice=150;p.delivery.managedServiceSelected=false;p.delivery.managedServicePrice=0;p.delivery.previewApproved=true;
