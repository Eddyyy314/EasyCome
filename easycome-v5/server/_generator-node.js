...
`;
  ...
  function generatePackage(projectInput) {
    ...
    return { project: configObject, entities, price, files: finalFiles, filename: `${project.company.slug || 'gestionale'}-easycome-hospitality-v2-final.zip` };
  }
